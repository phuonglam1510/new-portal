...
const getCompanyById = (id: ID): Promise<CompanyModel | undefined> => {
  return axios
    ...
    .then((response: AxiosResponse<GenericResponse<CompanyModel>>) => response.data)
    .then((response: GenericResponse<CompanyModel>) => Builder(CompanyModel, response.data).build())
}

const createCompany = (company: CompanyModel): Promise<CompanyModel | undefined> => {
  return axios
...
const updateCompany = (company: CompanyModel): Promise<CompanyModel | undefined> => {
  return axios
...
export {getCompanies, deleteSelectedUsers, deleteUser, updateCompany, createCompany, getCompanyById}
